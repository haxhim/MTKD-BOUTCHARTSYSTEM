...
import { ResetModal, type ResetScope } from '../components/ResetModal';
...
export const DashboardPage: React.FC = () => {
    const {
        ...
        rings,
        matches,
        tournamentId // Ensure this is available in context or use hook 
    } = useTournament();
    ...
    const handleReset = async (scope: ResetScope) => {
        ...
        try {
            switch (scope) {
                case 'all': await resetData(); break;
                case 'participants': await resetParticipants(); break;
                case 'rings': await resetRings(); break;
                case 'brackets': await resetBrackets(); break;
                case 'matches':
                case 'results': await resetMatchResults(); break;
            }
                ...
                <div className="space-y-4 sm:space-y-5">
                    <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm shadow-gray-200/50 border border-gray-100 p-4 sm:p-6">
                        ...
                        <div className="space-y-2 sm:space-y-3">
                            ...
                            <button
                                onClick={() => navigate(`/tournament/${tournamentId}/judge`)}
