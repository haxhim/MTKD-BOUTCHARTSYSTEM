    ...
    return (
        <div className="flex min-h-screen bg-gradient-to-br from-gray-50 via-slate-50 to-gray-100 font-sans text-gray-900">
            ...
            <main className="flex-1 flex flex-col min-h-screen lg:h-screen overflow-hidden">
                {/* Top Header */}
                <header className="h-14 sm:h-16 bg-white/80 backdrop-blur-md border-b border-gray-100 flex items-center justify-between px-3 sm:px-4 lg:px-8 sticky top-0 z-30 shadow-sm shadow-gray-100/50 no-print">
